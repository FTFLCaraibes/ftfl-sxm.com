...
{build_hreflang(slug)}
  ...
  <script src="https://unpkg.com/aos@2.3.4/dist/aos.js" defer></script>{window_lang}"""
  ...
  <div class="container">
    <div class="grid-4">
      <div class="service-card" data-aos="fade-up" data-aos-delay="0">
        ...
        <div class="service-icon"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 22h20"/><path d="M6.87 2h10.26L20 7H4L6.87 2Z"/><path d="M4 7h16v15H4V7Z"/><path d="M9 22V12h6v10"/></svg></div>
      ...
      <div class="service-card" data-aos="fade-up" data-aos-delay="80">
        ...
        <div class="service-icon"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></div>
      ...
      <div class="service-card" data-aos="fade-up" data-aos-delay="160">
        ...
        <div class="service-icon"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></div>
        ...
        <p data-i18n="svc3.p">FTFL prend en charge l'ensemble des travaux de finition et de réhabilitation.</p>
        <div class="service-tags">
      ...
      <div class="service-card" data-aos="fade-up" data-aos-delay="240">
        ...
        <div class="service-icon"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M4.93 4.93a10 10 0 0 0 0 14.14"/></svg></div>
        ...
        <p data-i18n="svc4.p">Un interlocuteur unique pour l'entretien courant et les interventions rapides.</p>
        <div class="service-tags">
    ...
    <div style="margin-top:80px;padding:48px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);border-radius:20px;" data-aos="fade-up">
      <h2 style="font-family:var(--font-head);font-size:1.6rem;font-weight:800;margin-bottom:20px;" data-i18n="services.seo.h">Pourquoi confier vos travaux à FTFL CARAÏBES ?</h2>
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:32px;">
        <p style="color:var(--gray-light);line-height:1.85;" data-i18n="services.seo.p1">Entreprise de construction implantée à Saint-Martin, FTFL CARAÏBES intervient sur l'ensemble de l'île — côté français comme côté hollandais. Notre polyvalence est notre force : un <strong style="color:#fff;">interlocuteur unique</strong> pour l'ensemble de vos travaux, des terrassements jusqu'aux finitions intérieures.</p>
        <p style="color:var(--gray-light);line-height:1.85;" data-i18n="services.seo.p2">Chaque projet bénéficie d'un <strong style="color:#fff;">chef de chantier dédié</strong>, d'un suivi quotidien et d'une communication transparente. Du devis gratuit à la livraison, FTFL s'engage à respecter les délais et les budgets convenus.</p>
      </div>
      ...
      <div data-aos="fade-right">
        <div class="contact-items">
          ...
          <a class="contact-item" href="mailto:contact@ftfl-sxm.com">
            ...
            <div class="contact-item-text"><span class="ci-label">Email</span><a href="mailto:contact@ftfl-sxm.com">contact@ftfl-sxm.com</a></div>
          </a>
